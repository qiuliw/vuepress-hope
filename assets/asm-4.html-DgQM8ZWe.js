import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as s,e as l}from"./app-BgnZuos0.js";const i={},n=l(`<h1 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h1><h2 id="算数运算指令" tabindex="-1"><a class="header-anchor" href="#算数运算指令"><span>算数运算指令</span></a></h2><p>算数运算指令的执行大多对状态标志位会产生影响</p><h3 id="mov" tabindex="-1"><a class="header-anchor" href="#mov"><span>MOV</span></a></h3><div class="language-asm line-numbers-mode" data-ext="asm" data-title="asm"><pre class="language-asm"><code>MOV AX,0;AX&lt;-0
MOV指令不影响标志位
